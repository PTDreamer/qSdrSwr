...
Callout::Callout(QChart *chart, QColor color):
    QGraphicsItem(chart), color(color),
    m_chart(chart)
{
}
...
void Callout::setColor(const QColor &value)
{
    color = value;
}
...
void Callout::setAnchor(QPointF point, QAbstractSeries *series)
{
    m_anchor = point;
    m_series = series;
}
